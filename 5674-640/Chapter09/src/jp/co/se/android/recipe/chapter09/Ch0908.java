    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_CODE_PICK_ACCOUNT) {
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(this, "계정을 선택해야 합니다.", Toast.LENGTH_SHORT)
                        .show();
            }
        ...
        new AuthorizationTask(this, email, SCOPE) {
            ...
            protected void onPostExecute(String accessToken) {
                ...
                if (e == null) {
                    ...
                    Toast.makeText(getApplicationContext(), "인증에 성공했습니다.",
                    ...
                    Toast.makeText(getApplicationContext(),
                            String.format("인증에 실패했습니다:\n%1$s", e),
                            Toast.LENGTH_SHORT).show();
                    Log.e(Ch0908.class.getSimpleName(), "인증에 실패", e);
                }
            }
