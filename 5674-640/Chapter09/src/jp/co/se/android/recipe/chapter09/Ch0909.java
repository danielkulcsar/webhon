...
public class Ch0909 extends Activity implements View.OnClickListener {
    ...
    private void requestProfile() {
        ...
        if (accessToken == null) {
            Toast.makeText(this, "인증이 끝나지 않았습니다.", Toast.LENGTH_SHORT).show();
            return;
        }
                ...
                if (e == null) {
                    ...
                    if (responseCode == 401) {
                        ...
                        Toast.makeText(Ch0909.this,
                                "액세스 토큰이 실패했습니다. 다시 인증하세요",
                                Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(Ch0909.this, "에러：" + e.getMessage(),
                                Toast.LENGTH_SHORT).show();
                    }
