...
public class Browser4 extends Activity {

	ProgressBar mProgressBar;
	//private String url = "hBrowser1ttp://m.naver.com";
	WebView browser;
	WebView web;
	...
	private void AlertShow(String string) {
		// TODO Auto-generated method stub
		AlertDialog.Builder alert_internet_status = new AlertDialog.Builder(Browser4.
				this);
